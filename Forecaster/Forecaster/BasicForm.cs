...
namespace Forecaster
{
  public class BasicForm : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (BasicForm));
      ...
      this.Controls.Add((Control) this.pageIndicator);
    ...
    public BasicForm() => this.InitializeComponent();
    ...
    private bool IsOverClientArea(IntPtr hwnd, IntPtr wParam, IntPtr LParam) => BasicForm.DefWindowProc(hwnd, 132, wParam, LParam).ToInt32() == 1;
    ...
    {
      bool enabled;
      BasicForm.DwmIsCompositionEnabled(out enabled);
    ...
    private void GetLocations()
    {
      ...
      this.locations.Add(Forecaster.Properties.Settings.Default.AdditionalLocations.Split('|')[0]);
      ++this.pageIndicator.Pages;
    }
    ...
    private TaskButton GetForecastButton(int forecastIndex)
    {
      ...
      forecastButton.Height = 52;
      forecastButton.Image = (Bitmap) null;
      forecastButton.ImageSize = 48;
      ...
      forecastButton.Width = this.flowLayoutPanel1.Width - 4;
    ...
    private void GetCurrentConditions()
    {
      ...
      {
        this.Invoke((Delegate) new BasicForm.GetCurrentConditionsDelegate(this.GetCurrentConditions), new object[0]);
      }
      else
      {
        ...
        try
        {
          ...
          this.headerPanel1.Condition = current.Condition;
    ...
    private void GetExtendedConditions()
    {
      if (this.InvokeRequired)
      {
        this.Invoke((Delegate) new BasicForm.GetExtendedForecastDelegate(this.GetExtendedConditions), new object[0]);
      }
      else
      {
        int currentPage = this.pageIndicator.CurrentPage;
        ...
        try
        {
          ...
          for (int index = 0; index < this.flowLayoutPanel1.Controls.Count; ++index)
          {
            ...
            control.Temperature = string.Format("High: {0} / Low: {1}", (object) Helper.GetTemperature(extended[index], extended[index].High), (object) Helper.GetTemperature(extended[index], extended[index].Low));
